...
export const FeatureSection = () => {
    return (
        <>
            <section className="container bg-black grid gap-6 md:grid-cols-2 pb-8 pt-8 md:py-10">
                <div className="flex flex-col gap-2 rounded-lg bg-gray-500 md:p-12 p-6">
                ...
                <div className="col-span-full flex flex-col gap-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
                        <div className="flex flex-col gap-4 md:gap-0">
                            ...
                            <Button asChild className="rounded-full hidden mt-4 md:mt-auto md:flex">
                        ...
                        <div className="flex flex-col items-center justify-center w-full">
                            <div className="w-full max-w-md overflow-hidden">
                                <Image src="/feature-section.png" alt="Features" width={440} height={330} className="object-cover w-full" />
                            </div>
                            <Button asChild className="w-full gap-2 rounded-full md:hidden mt-4 md:mt-auto">
                                <Link href="/criar-loja">
                                    Criar loja grátis
                                    <ArrowRight />
                                </Link>
